import { getCurrentInstance, toRaw, isRef, isReactive, toRef, version, inject, useSSRContext, ref, watchEffect, watch, defineComponent, unref, withCtx, createVNode, createApp, reactive, markRaw, effectScope, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, getCurrentScope, onScopeDispose, nextTick, computed, h, Suspense, Transition, defineAsyncComponent, toRefs, shallowRef, isReadonly, isShallow } from 'vue';
...
import { a as useRuntimeConfig$1, d as defu } from './node-server.mjs';
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "name": "description", "content": "A Blog for Skelanimals, Skelanimals 的个人博客" }, { "name": "Keywords", "content": "个人博客,skelanimals,前端博客,Vue" }, { "name": "apple-mobile-web-app-status-bar-style", "content": "black-translucent" }], "link": [{ "rel": "icon", "href": "/favicon.ico", "sizes": "any" }, { "rel": "icon", "type": "image/svg+xml", "href": "/nuxt.svg" }, { "rel": "apple-touch-icon", "href": "/apple-touch-icon.png" }], "style": [], "script": [], "noscript": [], "viewport": "width=device-width,initial-scale=1" };
...
const revive_payload_server_NOLq1bdnod = /* @__PURE__ */ defineNuxtPlugin({
...
const unhead_sKxlf2F1h3 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_...all_-992ef678.mjs').then((m) => m.default || m)
  },
  {
    name: "blog-id",
    path: "/blog/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_id_-2c92e80e.mjs').then((m) => m.default || m)
  },
  {
    name: "blog",
    path: "/blog",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./index-62904a2e.mjs').then((m) => m.default || m)
  }
];
...
const router_xAUqwq5qBJ = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  async setup(nuxtApp) {
    var _a, _b;
...
const _plugins = [
  plugin,
  revive_payload_server_NOLq1bdnod,
...
const appName = "Skelanimals Blog";
const DEFAULT_THEME = {
  light: {
    primary: "#12AC9E",
    success: "#38C066",
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(StarportCarrier), _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_VitePwaManifest, null, null, _parent2, _scopeId));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./error-component-8b775eea.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-d9adb0e8.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.4.3_@types+node@18.14.0_eslint@8.40.0_rollup@2.79.1_sass@1.62.1_typescript@5.0.4_vue-tsc@1.6.4/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { DEFAULT_THEME as D, useRoute as a, useNuxtApp as b, createError as c, defineStore as d, entry$1 as default, useState as e, useHead as f, appName as g, navigateTo as n, storeToRefs as s, useRouter as u };
