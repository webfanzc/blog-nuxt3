globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/node-fetch-native@1.1.0/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/registry.npmmirror.com+std-env@3.3.2/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/h3@1.6.5/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/vue-bundle-renderer@1.0.3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/devalue@4.3.0/node_modules/devalue/index.js';
import { renderToString } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/vue@3.2.47/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/ofetch@1.0.1/node_modules/ofetch/dist/node.mjs';
import destr from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/destr@1.2.2/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/unenv@1.4.1/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/scule@1.0.0/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/registry.npmmirror.com+defu@6.1.2/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/ohash@1.1.2/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/ufo@1.1.1/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/unstorage@1.4.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/unstorage@1.4.1/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/blog-upgrade/blog-nuxt3/node_modules/.pnpm/radix3@1.0.1/node_modules/radix3/dist/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false},"/api/**":{"proxy":{"to":"http://localhost:3000/**","_proxyStripBase":"/api"}},"/images/**":{"proxy":{"to":"http://localhost:3000/images/**","_proxyStripBase":"/images"}}}},"public":{}};
...
const serverAssets = [{"baseName":"server","dir":"E:/blog-upgrade/blog-nuxt3/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\blog-upgrade\\blog-nuxt3","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\blog-upgrade\\blog-nuxt3\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\blog-upgrade\\blog-nuxt3\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\blog-upgrade\\blog-nuxt3\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_s7pkWg = () => Promise.resolve().then(function () { return renderer$1; });
...
const getClientManifest = () => import('file://E:/blog-upgrade/blog-nuxt3/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://E:/blog-upgrade/blog-nuxt3/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\" content=\"A Blog for Skelanimals, Skelanimals 的个人博客\">\n<meta name=\"Keywords\" content=\"个人博客,skelanimals,前端博客,Vue\">\n<meta name=\"apple-mobile-web-app-status-bar-style\" content=\"black-translucent\">\n<link rel=\"icon\" href=\"/favicon.ico\" sizes=\"any\">\n<link rel=\"icon\" type=\"image/svg+xml\" href=\"/nuxt.svg\">\n<link rel=\"apple-touch-icon\" href=\"/apple-touch-icon.png\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
